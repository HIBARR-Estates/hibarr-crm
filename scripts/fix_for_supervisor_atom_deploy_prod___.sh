...
[program:hibarr_crm_expose]
process_name=%(program_name)s_%(process_num)02d
command=/usr/bin/php /home/hibarr/hibarr-crm/artisan queue:work database --queue=expose --sleep=1 --tries=1 --timeout=660
autostart=true
autorestart=true
user=hibarr
numprocs=1
redirect_stderr=true
stdout_logfile=/home/hibarr/shared/expose-worker.log
stopwaitsecs=7200
EOF
...
sudo supervisorctl restart hibarr_crm:*
sudo supervisorctl restart hibarr_crm_expose:*
