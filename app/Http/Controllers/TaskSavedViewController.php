...
class TaskSavedViewController extends AccountBaseController
{
    public function __construct()
    {
        ...
        $this->middleware(function ($request, $next) {
            ...
            // Saved views exist only as part of the redesigned tasks workspace.
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $view = TaskSavedView::create([
            ...
            'user_id' => user()->id,
            'name' => $data['name'],
            'filters' => TaskSavedView::sanitizeFilters($data['filters'] ?? []),
    ...
    {
        $view = TaskSavedView::findOrFail($id);
        ...
        if (array_key_exists('filters', $data)) {
            $view->filters = TaskSavedView::sanitizeFilters($data['filters']);
        }
    ...
    private function validated(Request $request, bool $partial = false): array
    {
        ...
        return $request->validate([
            ...
            'visibility' => [
                $required,
                Rule::in([TaskSavedView::VISIBILITY_PRIVATE, TaskSavedView::VISIBILITY_TEAM]),
            ],
     ...
     * @return array<string, mixed>
     */
    private function present(TaskSavedView $view): array
    {
