...
class DashboardController extends AccountBaseController
{
    ...
    public function dashboardOverview()
    {
        ...
        $overviewMetrics = $this->dashboardService->getOverviewMetrics($dealsConstraint, $leadsConstraint, $tasksConstraint);
        $tasks = $this->dashboardService->getTasks($tasksConstraint);
        $stats = $this->dashboardService->getStats($dealsConstraint, $tasksConstraint);
        $recentDeals = $this->dashboardService->getRecentDeals($dealsConstraint);
        $recentActivities = $this->dashboardService->getRecentActivities($dealsConstraint);
        $pipelineStages = $this->dashboardService->getPipelineStages();
        ...
        return Inertia::render('Dashboard/ComprehensiveDashboard', array_merge([
            'tasks' => $tasks,
            'deals' => [], // We don't need all deals anymore, just recent ones or stats
            'recentDeals' => $recentDeals,
            'poorDataQualityDeals' => Inertia::lazy(fn () => $this->dashboardService->calculateDataQuality($dealsConstraint, $leadsConstraint)['records']),
            'dataQualityStats' => Inertia::lazy(fn () => $this->dashboardService->calculateDataQuality($dealsConstraint, $leadsConstraint)['stats']),
