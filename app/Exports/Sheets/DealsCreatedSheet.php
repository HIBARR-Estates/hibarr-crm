...
class DealsCreatedSheet implements FromCollection, WithHeadings, WithMapping, WithTitle
{
    ...
    {
        return $this->service->listCreated($this->agentIds, $this->start, $this->end, 10000)->getCollection();
    }

    public function headings(): array
    {
        return ['Deal Name', 'Contact', 'Stage', 'Value', 'Agent', 'Created At'];
    }
