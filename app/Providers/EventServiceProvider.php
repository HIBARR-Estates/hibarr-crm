...
use App\Observers\LeadContactFileObserver;
...
use App\Observers\PropertyAssetObserver;
...
class EventServiceProvider extends ServiceProvider
{
    ...
    protected $listen = [
        ...
        EventCompletedEvent::class => [EventCompletedListener::class],
    ...
    protected $observers = [
        ...
        DealFollowUp::class => [DealFollowUpObserver::class, LeadFollowUpObserver::class],
        LeadNote::class => [LeadNoteObserver::class],
        LeadContactFile::class => [LeadContactFileObserver::class],
        ...
        PropertyAsset::class => [PropertyAssetObserver::class],
