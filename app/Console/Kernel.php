...
use App\Console\Commands\ProcessAutomationPendingRuns;
...
class Kernel extends ConsoleKernel
{
    ...
    protected $commands = [
        ...
        ProcessAutomationPendingRuns::class,
    ];
    ...
    protected function schedule(Schedule $schedule)
    {
        ...
        $schedule->command('deal-automations:process-pending-runs')->everyMinute()->withoutOverlapping();
        ...
        // Trims email_delivery_logs (see config/mail.php delivery_log_retention_days).
        $schedule->command('model:prune', ['--model' => [\App\Models\EmailDeliveryLog::class]])->dailyAt('02:45');
