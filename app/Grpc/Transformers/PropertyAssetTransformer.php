...
/**
 * Transforms PropertyAsset Eloquent models to gRPC message arrays.
 */
class PropertyAssetTransformer
{
    /**
     * Transform a PropertyAsset model to a gRPC-compatible array.
     *
     * @param PropertyAsset $record
     * @return array
     */
    public function transform(PropertyAsset $record): array
    {
        return [
            'id' => (int) $record->id,
            'property_id' => (int) ($record->property_id ?? 0),
