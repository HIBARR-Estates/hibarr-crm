...
/** Sticky bar shown while a list is in bulk-select mode, ported from v2.2's BulkActionBar. */
export default function DealBulkActionBar({
    count,
    onClear,
    clearLabel,
    children,
    ...
    return (
        ...
        >
            ...
            <button
                ...
                style={{ opacity: count ? 0.9 : 0.4, cursor: count ? "pointer" : "default" }}
            >
                {clearLabel}
            </button>
        </div>
