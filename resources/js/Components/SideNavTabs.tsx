    ...
    return (
        ...
        >
                ...
                {items.map((item) => {
                    ...
                    const btn = (
                        <button
                            ...
                            className={`w-full flex items-center gap-2 px-2 py-2 text-left border-l-2 transition-colors duration-150 cursor-pointer ${isActive
                                ? "border-blue-600 bg-blue-50 text-blue-700"
                                : "border-transparent text-gray-600 hover:bg-gray-50 hover:text-gray-900"
                                }`}
                        >
                            <span
                                className={`shrink-0 inline-flex items-center justify-center w-7 h-6 rounded text-[10px] font-bold tracking-wide ${isActive
            ...
            <button
                ...
                className="cursor-pointer flex items-center justify-center py-2 border-t border-gray-100 text-gray-400 hover:text-gray-600 hover:bg-gray-50 transition-colors duration-150 shrink-0"
