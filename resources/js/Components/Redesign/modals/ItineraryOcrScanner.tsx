...
import useFlightItineraryOcr from "@/Components/Redesign/hooks/useFlightItineraryOcr";
...
interface ItineraryOcrScannerProps {
    disabled?: boolean;
...
/**
 * Upload-a-ticket-image entry for ItineraryModal. Sends the image to the OL
 * flight-itinerary OCR endpoint, polls until the job resolves, and lets the
 * user apply a detected flight onto the itinerary form.
 */
