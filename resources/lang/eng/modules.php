...
return [
    'dashboard' => [
        ...
        'totalPendingFollowUps' => 'Pending Meetings',
    ...
    'properties' => [
        ...
        'rentPaymentInterval' => 'Rent Payment Interval',
        'titleDeed' => 'Title Deed',
        'titleDeedType' => 'Title Deed Type',
        'titleDeedStage' => 'Title Deed Stage',
    ...
    'accountSettings' => [
        ...
        'meetingAttendanceConfirmationDelayMinutes' => 'Confirmation delay (minutes)',
        'meetingAttendanceConfirmationDelayMinutesHelp' => 'How long after a meeting ends before agents are prompted to confirm the outcome. Leave blank to use the default.',
        'meetingAttendanceConfirmationSnoozeMinutes' => 'Snooze duration (minutes)',
        'meetingAttendanceConfirmationSnoozeMinutesHelp' => 'How long "Snooze" hides a meeting from the reminders dock before prompting again. Leave blank to use the default.',
    ...
    'settings' => [
        ...
        'reminderPreferencesDescription' => 'Configure when you want to receive reminders before meetings and events.',
        'reminderDefaults' => 'Reminder Defaults',
        'reminderDefaultsDescription' => 'Company defaults for when reminder emails are sent before an event. Specific entity types override the All entities fallback.',
        'entityReminderDefaults' => 'Reminder Defaults',
        'entityReminderDefaultsDescription' => 'Company defaults for when reminder emails are sent before an event. Specific entity types override the All entities fallback.',
        'addEntityDefault' => 'Add entity default',
        'noReminderDefaults' => 'No reminder defaults configured yet. Add an entity type to get started.',
        ...
        'mailEntityTypes' => [
            'meeting' => 'Meeting (DealFollowUp)',
            'task' => 'Task',
            'note' => 'Note (DealNote / LeadNote)',
            'deal' => 'Deal',
            'lead' => 'Lead',
            'property' => 'Property',
            'project' => 'Project (DeveloperProject)',
            'unit' => 'Unit (DeveloperProjectUnitType)',
            'flight' => 'Flight (LeadFlightItinerary)',
        ],
        'emailTemplates' => 'Reminder Email Templates',
        'emailTemplatesDescription' => 'Plunk template IDs used when sending reminder emails via UNS. Leave blank to send the branded HTML email body instead. Changes apply immediately.',
        'plunkTemplateId' => 'Plunk Template ID',
        'saveEmailTemplates' => 'Save Templates',
        'reminderLedgerDescription' => 'All scheduled and sent reminder emails for this company. Use filters to find pending, failed, or entity-specific rows.',
        'reminderLedgerSearchPlaceholder' => 'Email, message, error, or entity id',
        'noRemindersFound' => 'No reminders found for the current filters.',
        'entityType' => 'Entity type',
        'remindAt' => 'Remind at',
        'sentAt' => 'Sent at',
        'meetingReminders' => 'Meeting Reminders',
        'enableMeetingReminders' => 'Enable meeting reminders',
    ...
    'customFields' => [
        ...
        'displayConfig' => 'Default display (aggregate)',
        'useDefaultDisplay' => 'Show aggregated value instead of full list',
        'aggregateFieldKey' => 'Field to aggregate (schema key)',
        'aggregateBy' => 'Aggregate by',
        'aggregateByFirst' => 'First value',
        'aggregateByLast' => 'Last value',
        'aggregateByConcat' => 'All values (joined)',
        'aggregateByList' => 'List (joined)',
        'aggregateBySum' => 'Sum (numbers)',
        'aggregateBySumCurrency' => 'Sum (currencies)',
        'aggregateByCount' => 'Count (number of items)',
        'displayConfigSeparator' => 'Separator (for join)',
        'displayConfigFormat' => 'Display format (use {value})',
    ],
    'statusFields' => [
    ...
    'lead' => [
        ...
        'lifecycleStatus' => 'Contact Lifecycle',
        'addLifecycleStatus' => 'Add Contact Lifecycle Status',
        'editLifecycleStatus' => 'Edit Contact Lifecycle Status',
        'lifecycleStatusKeyPlaceholder' => 'e.g. vip_lead',
        'lifecycleStatusKeyCreateHelp' => 'Use lowercase letters, numbers, and underscores only. Reserved system keys cannot be reused.',
        'lifecycleStatusKeyReserved' => 'This key is reserved for a system status.',
        'lifecycleStatusKeyFormat' => 'Key must start with a letter and contain only lowercase letters, numbers, and underscores.',
        'lifecycleStatusKey' => 'Status Key',
        'lifecycleStatusKeyImmutable' => 'The status key is fixed and used by qualification workflows.',
        'lifecycleStatusHelp' => 'Contact lifecycle statuses track lead qualification progress. Deal pipeline stages are configured under the Pipeline tab.',
        'leadsUsingStatus' => 'Leads',
        'lifecycleStatusInUse' => 'In use',
        'lifecycleStatusInUseWarning' => ':count lead(s) currently have this status. Label and display changes will apply to all of them.',
        'noLifecycleStatuses' => 'No lifecycle statuses found. Run migrations to seed default statuses.',
        'editFollowUp' => 'Edit Meeting',
    ...
    'followup' => [
        ...
        'newFollowUp' => 'New Meeting',
        'updateFollow' => 'Update Meeting',
        'addNewLead' => 'Add New Proposal',
        'viewDetails' => 'View Details',
        'title' => ' Lead Proposal',
        'proposal' => ' Lead Proposal',
        ...
        'updateProposal' => 'Update Proposal',
        'convertProposalTitle' => 'Convert Proposal To Invoice',
        'followUpNotFound' => 'No meeting found',
    ...
    'emailNotification' => [
        ...
        'deal-activity-notification' => 'Deal Activity Notification',
    ...
    'deal' => [
        ...
        'dealPackageMode' => 'Packages per deal',
        'dealPackageModeSingle' => 'One package per deal (enables pipeline routing)',
        'dealPackageModeMultiple' => 'Multiple packages per deal (disables pipeline routing)',
        'dealPackageModeHint' => 'Single-package mode limits each deal to one package. Automatic pipeline routing runs when a deal has exactly one package and routing is enabled above.',
        'firstStageDefault' => 'First stage (default)',
        'packagePipelineLinkage' => 'Pipeline routing',
        'packagePipelineLinkageHint' => 'Optionally link this package to a pipeline. When routing is enabled in deal package settings, deals with this package can be moved to the linked pipeline automatically.',
        'packageRoutingTriggers' => 'Field routing triggers',
        'packageRoutingTriggersHint' => 'When a deal field matches your rule, the deal is assigned this package and moved to its linked pipeline.',
        'routingTriggerField' => 'Deal field',
        'routingTriggerMatchMode' => 'When to route',
        'routingTriggerMatchModeExact' => 'Value equals',
        ...
        'packagePipelineRoutingTriggerFieldsHint' => 'Choose which deal fields are allowed to trigger package pipeline routing. Configure per-package match rules in package settings.',
        'pipelineScopeSelectedCount' => ':count selected',
        'pipelineScopeNoMatches' => 'No matches',
        'pipelineScopeAllSelected' => 'All options selected',
    ...
    'meeting' => [
        ...
        'messages' => [
            ...
            'deleted' => 'Meeting summary deleted successfully',
