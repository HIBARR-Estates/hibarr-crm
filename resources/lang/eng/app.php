...
return [
    ...
    'menu' => [
        ...
        'metaConversionTriggers' => 'Meta Conversion Triggers',
    ...
    'settingsHub' => [
        ...
        'leadsDesc' => 'Company defaults for how leads are handled, including sources, statuses, and first-contact timing.',
        ...
        'notesDesc' => 'Manage note types and visibility defaults.',
        'reminders' => 'Reminders',
    ...
    'automation' => [
        'overview' => 'Overview',
        'overviewSubtitle' => 'How your automations are performing across leads, deals and meetings.',
        'automation' => 'Automation',
        'automations' => 'Automations',
        'automationsSubtitle' => 'Rules that run automatically when something happens in the CRM.',
        'emailTemplates' => 'Email templates',
        'templatesSubtitle' => 'Reusable emails your automations send. Personalise with merge tags.',
        'metaEvents' => 'Meta events',
        'metaEventsSubtitle' => 'Named conversion events with a default value, ready to pick in a Meta Conversion automation step.',
        'newMetaEvent' => 'New meta event',
        'editMetaEvent' => 'Edit meta event',
        'noMetaEventsYet' => 'No meta events yet',
        'noMetaEventsYetDescription' => 'Create one to pick it from a Meta Conversion automation step instead of typing a name and value every time.',
        'usedByAutomations' => 'Used by {{count}} automation(s)',
        'notUsedYet' => 'Not used yet',
        'sendTestEvent' => 'Send test event',
        'sendTestEventHint' => 'Sends a real Meta Conversions API event for one lead right now, bypassing automations entirely — use it to verify your pixel and access token before trusting an automation to send the same thing.',
        'testLeadId' => 'Lead',
        'testLeadIdPlaceholder' => 'Search leads by name or email…',
        'testEventCode' => 'Test event code (optional)',
        'testEventCodePlaceholder' => 'e.g. TEST73823',
        'testEventCodeHint' => "Meta's standard way to test events — find yours under Events Manager > Test Events. When set, the event shows up live there instead of counting toward real ad reporting.",
        'testEventAccepted' => 'Accepted by Meta (HTTP {{status}})',
        'testEventFailed' => 'Rejected by Meta',
        'runHistory' => 'Run history',
        'runHistorySubtitle' => 'Every time an automation fired, and what happened.',
        'channels' => 'Channels',
        ...
        'noAutomationsFoundDescription' => 'Try a different search or filter.',
        'noTemplatesYet' => 'No email templates yet',
        'noTemplatesYetDescription' => 'Create your first template to use it in a send_email automation step.',
        'noTemplatesFound' => 'No templates found',
        'noTemplatesFoundDescription' => 'Try a different search or filter.',
        'leadAutomation' => 'Lead automation',
        'dealAutomation' => 'Deal automation',
        'toggleAutomation' => 'Toggle automation',
        'active' => 'Active',
        'paused' => 'Paused',
        ...
        'stats' => [
            ...
            'configuredWait' => 'Configured wait',
            'recordsFiredFor' => 'Records fired for',
        ],
        'noActivityYet' => 'No activity yet',
        'noActivityYetDescription' => 'Runs will show up here as soon as an automation fires.',
        'noAutomationsYet' => 'No automations yet',
        'noAutomationsYetDescription' => 'Create your first automation to start running actions automatically.',
        'immediate' => 'Immediate',
        'backToAutomations' => 'Back to automations',
        'backToTemplates' => 'Back to templates',
        'builderSubtitle' => 'Build the flow: pick what starts it, add optional conditions, then the steps that run.',
        ...
        'settings' => 'Settings',
        'status' => 'Status',
        'statusHint' => 'Active automations run live',
        'summary' => 'Summary',
        'summaryText' => 'Starts on {{trigger}}, then runs {{count}} step(s).',
        'editFlow' => 'Edit flow',
        'deals' => 'Deals',
        'leads' => 'Leads',
        'automationFor' => 'For',
        ...
        'waitBeforeRunning' => 'Wait before running',
        'runsImmediately' => 'Runs immediately',
        'runImmediately' => 'Run immediately',
        'waitsDurationBeforeContinuing' => 'Waits {{value}} {{unit}} before continuing',
        'waitFor' => 'Wait',
        'beforeRunning' => 'before running',
        'searchFields' => 'Search fields…',
        'noFieldsMatch' => 'No fields match',
        'insertMergeTag' => 'Insert a merge tag',
        'value' => 'Value',
        'field' => 'Field',
        ...
        'title' => 'Title',
        'noteTitleOptional' => 'Note Title (Optional)',
        'description' => 'Description',
        'content' => 'Content',
        'assignTo' => 'Assign to',
        'createdBy' => 'Created / added by',
        'dueIn' => 'Due in',
        'dueTime' => 'Due time',
        'eventName' => 'Event name',
        'eventValue' => 'Event value',
        'eventNamePlaceholder' => 'e.g. Qualified, Committed',
        ...
        'editorSubtitle' => 'Edit the content on the left; the preview updates with sample data.',
        'sendTest' => 'Send test',
        ...
        'body' => 'Body',
        'bodyHint' => 'Simple content (paragraphs, links, an occasional table) is automatically wrapped in a standard centered email layout. Paste a complete <html>…</html> document to take full control of the design instead.',
        'preview' => 'Preview',
        'desktop' => 'Desktop',
        'mobile' => 'Mobile',
        'from' => 'From',
        ...
        'notUsedYet' => 'Not used yet',
        'usedInCount' => 'Used in {{count}} automations',
        'duplicate' => 'Duplicate',
        'refresh' => 'Refresh',
        'export' => 'Export',
    ...
    'currency' => 'Currency',
    'range' => 'Range (min - max)',
    'currency_range' => 'Currency Range (min - max)',
    'draft' => 'Draft',
    'label' => 'Label',
    'labelName' => 'Label Name',
    'color' => 'Color',
    ...
    'renameApiToken' => 'Rename API Token',
    'apiTokenEndpoints' => 'Endpoints',
    ...
    'activities' => [
        ...
        'contactHasNoInstagram' => 'Contact has no instagram username',
        'noTelegramChatIdTitle' => 'No Telegram Chat ID',
        'noTelegramChatIdMessage' => 'No telegram chat ID for this contact to start conversation',
        'view' => 'View',
        'noTelegramUsername' => 'No Telegram Username',
        'contactHasNoTelegram' => 'Contact has no telegram username',
