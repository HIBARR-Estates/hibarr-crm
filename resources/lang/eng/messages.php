...
return array(
    ...
    'editAccessRequestApproved' => 'Edit access request approved. Collaborator access granted.',
    'editAccessRequestDenied' => 'Edit access request denied.',
    'activeEditAccessRequestExists' => 'You already have a pending edit access request for this property.',
    'alreadyCollaborator' => 'You already have edit access to this property.',
    'collaboratorRemoved' => 'Collaborator access removed successfully.',
    'collaboratorNotFound' => 'Collaborator not found on this property.',
    'cannotRemovePropertyCreator' => 'The property creator cannot be removed.',
    'watcherAdded' => 'You are now watching this property.',
    'watcherRemoved' => 'Watcher removed successfully.',
    'watchersUpdated' => 'Property watchers updated successfully.',
    ...
    'tooManyReminders' => 'You can add up to 20 reminders',
    'reminderTimeRequired' => 'Reminder time is required',
    'reminderTimeMustBeNumber' => 'Reminder time must be a number',
    'reminderTimeMin' => 'Reminder time cannot be negative',
    'reminderTimeMax' => 'Reminder time cannot exceed 7 days',
    'reminderTypeRequired' => 'Reminder type is required',
    'invalidReminderType' => 'Invalid reminder type',
    'dealSaved' => 'Deal saved successfully',
    'leadSaved' => 'Contact saved successfully',
    ...
    'apiTokenRegenerated' => 'API token regenerated successfully.',
    'apiTokenSettingsHelp' => 'Create and manage API tokens for server-to-server integrations. Restrict each token to specific API endpoints, or grant full access. Use the X-API-TOKEN header or Authorization: Bearer <token> with X-COMPANY-ID when calling CRM API endpoints.',
    'apiTokenNameHelp' => 'A label to identify this token, e.g. "OL Integration" or "n8n Automation".',
    'noApiTokensFound' => 'No API tokens found. Create one to get started.',
    'apiTokenCopyNowTitle' => 'Copy your API token',
    'apiTokenCopyNowWarning' => 'This token will only be shown once. Copy it now and store it securely. You will not be able to view it again.',
    'apiTokenUsageHint' => 'Send this token via the X-API-TOKEN header or as a Bearer token, along with X-COMPANY-ID, on CRM API requests.',
    'apiTokenRevokeConfirm' => 'Revoked tokens cannot be used for API requests until reactivated.',
    'apiTokenActivateConfirm' => 'This token will be able to authenticate API requests again.',
    'apiTokenRegenerateConfirm' => 'Regenerating ":name" will invalidate the current token immediately. Any integrations using it must be updated.',
    'apiTokenDeleteConfirm' => 'Permanently delete ":name"? This cannot be undone.',
    'copiedToClipboard' => 'Copied to clipboard',
    'apiTokenEndpointForbidden' => 'This API token is not authorized for the requested endpoint.',
    'apiTokenUnrestrictedAccess' => 'Allow access to all API endpoints',
    'apiTokenScopesHelp' => 'Select only the endpoints this token should be allowed to call. Leave unrestricted for full access.',
    'apiTokenScopesRequired' => 'Select at least one endpoint, or enable full access.',
    'apiTokenFullAccess' => 'Full access',
    ...
    'taskUpdated' => 'Task marked as :status.',
    ...
    'notificationsMarkedRead' => '{0} No notifications marked as read.|{1} :count notification marked as read.|[2,*] :count notifications marked as read.',
    'notificationsDeleted' => '{0} No notifications deleted.|{1} :count notification deleted.|[2,*] :count notifications deleted.',
    ...
    'confirmWithSsoInfo' => 'Sign in with single sign-on? Confirm with your provider instead of your password.',
    'confirmWithSso' => 'Confirm with :provider',
    'ssoConfirmationFailed' => 'We could not confirm your identity with your single sign-on provider. Please try again.',
