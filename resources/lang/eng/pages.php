...
return [
    ...
    'dashboard' => [
        ...
        'tour' => [
            ...
            'steps' => [
                ...
                'team_stats' => [
                    ...
                    'body' => 'Headline counts for everyone below you — not your own activity. Hover the (i) on a card for how each number is defined.',
                ],
                'team_network' => [
                    'title' => 'Your network map',
                    'body' => 'Pan and zoom the canvas, then click a person (or yourself at the top) to compare their own figures with their whole branch.',
                ],
                'team_charts' => [
                    'title' => 'Trend and growth',
                    'body' => 'Commission paid month by month, and how many agents joined over the same window.',
                ],
                'team_recent' => [
                    'title' => 'Recent commissions',
                    'body' => 'The latest legs paid to your network, including reversals, newest first.',
                ],
                'team_closing' => [
                    'title' => "You're ready",
                    'body' => 'Replay this guide anytime from Replay guide while you are on the Team dashboard.',
                ],
            ],
        ],
        'team' => [
            'tiles' => [
                'agents' => 'Agents',
                'agents_hint' => 'Everyone below you at any depth — you are not counted. {{direct}} direct reports · {{levels}} levels deep.',
                'deals' => 'Deals',
                'deals_hint' => 'Active: every open deal in the network right now. Won: deals closed in the last {{period}} days.',
                'active' => 'Active',
                'won' => 'Won',
                'leads' => 'Leads',
                'leads_hint' => 'Untouched: still open with no first contact logged. Contacted: open leads with first contact made — not windowed, same as active deals.',
                'untouched' => 'Untouched',
                'contacted' => 'Contacted',
                'earnings' => 'Earnings',
                'earnings_hint' => 'Paid: commission the network actually received in the last {{period}} days. Pending: balance still owed, as of now. Forecast: estimated from open deals today, not yet earned.{{forecast}} You are never included in these totals.',
                'earnings_forecast_sampled' => ' Forecast samples the most recently updated open deals when the network has too many to price at once.',
                'earnings_forecast_deals' => ' Forecast is priced from {{count}} open deal(s).',
                'paid' => 'Paid',
                'pending' => 'Pending',
                'forecast' => 'Forecast',
            ],
            'panels' => [
                'network_title' => 'Your network',
                'network_note' => 'Pan · zoom · click a person',
                'commission_trend_title' => 'Commission trend',
                'commission_trend_note' => 'Paid per month · last {{period}} days',
                'network_growth_title' => 'Network growth',
                'network_growth_note' => 'Joins per month · running total',
                'recent_commissions_title' => 'Recent commissions',
                'recent_commissions_note' => 'Newest first · includes reversals',
            ],
            'detail' => [
                'click_anyone' => 'Click anyone in the network above — including yourself at the top — to see their numbers.',
                'your_whole_network' => 'Your whole network',
                ...
                'pending' => 'Pending',
                'forecast' => 'Forecast',
                'same_totals' => 'The same totals as the tile row above — everyone below you, none of your own activity.',
                'won_paid_cover' => 'Won and paid cover the last {{period}} days.',
                'loading_totals' => "Loading your network's totals…",
                'their_whole_branch' => 'their whole branch',
                'as_of_now' => 'Active deals, contacted leads, pending and forecast are all as of right now.',
                'view_leads' => 'Their leads',
                'view_deals' => 'Their deals',
            ],
            'no_agent' => [
                'title' => 'You have no agent record',
                'body' => 'A network is read from your own agent record. Ask an administrator to create one and set the agents who report to you.',
            ],
            'graph' => [
                'empty_title' => 'Nobody reports to you yet',
                'empty_body' => 'An agent joins your network when your agent record is set as their parent agent.',
                'you' => 'You',
                'no_level' => 'No level',
                'network_paid' => 'Network paid',
                'active_deals' => 'Active deals',
                'you_hint_title' => 'The same totals as the tile row above, for the whole network below you.',
                'click_breakdown' => 'Click for the full breakdown',
                'paid' => 'Paid',
                'branch_hint_title' => "This person's own figures are below. This line adds everyone under them in the network.",
                'branch_active_deals' => 'Branch: {{count}} active deals',
                'more' => 'more',
                'show_less' => 'Show less',
            ],
            'charts' => [
                'commission_paid' => 'Commission paid',
                'commission_empty' => 'No commission paid to the network in this window',
                'commission_aria' => 'Commission paid to the network, month by month',
                'new_agents' => 'New agents',
                'network_size' => 'Network size',
                'growth_empty' => 'No months in this window to plot',
                'growth_aria' => 'New agents each month against the running network size',
            ],
            'commissions' => [
                'empty_title' => 'No commission activity yet',
                'empty_body' => 'Entries appear here as soon as a deal anywhere in the network closes.',
                'type_agent' => 'Agent',
                'type_upline' => 'Upline',
                'status_paid' => 'Paid',
        ...
        'personal' => [
            'title' => 'Dashboard',
            'panels' => [
                'queue_title' => 'Needs your attention',
                'pipeline_title' => 'Open deals by pipeline',
            ],
            'actions' => [
                'open' => 'open',
                'add_task' => 'Add task',
                ...
                'open_deal_list' => 'Open the deal list',
            ],
            'status' => [
                'one_task' => '1 task that needs your attention',
                'n_tasks' => '{{count}} tasks that need your attention',
                'pending_in_deals' => 'pending in open deals',
                'and' => 'and',
                'you_have' => 'You have',
                'take_action' => 'take action below',
                'nothing_needs_you' => 'Nothing needs you right now.',
            ...
            'queue' => [
                ...
                'empty_body_1' => 'No task is overdue and nothing is upcoming.',
                'empty_body_2' => 'Tasks appear here the moment one of those stops being true.',
            ],
            'severity' => [
                'now' => 'Now',
                'soon' => 'Soon',
            ...
            'due' => [
                'one_day_overdue' => '1 day overdue',
                'days_overdue' => '{{count}} days overdue',
                'due_at' => 'Due {{time}}',
                'due_today' => 'Due today',
                'due_weekday' => 'Due {{day}}',
                'due_date' => 'due {{date}}',
                'due_today_lower' => 'due today',
                'tomorrow' => 'tomorrow',
            ...
            'stats' => [
                ...
                'leads_empty_ratio' => 'New enquiries land here as they arrive',
                'deals_empty_ratio' => 'Convert a lead and the deal appears here',
                'meetings_empty_ratio' => 'Nothing logged in this window yet',
                'commission_empty_ratio' => 'Nothing pending right now',
            ],
            'pipeline' => [
                'empty_title' => 'No open deals',
                'empty_body' => 'Deals appear here per pipeline as soon as you convert a lead. Won and lost deals are never counted.',
                'deal' => 'deal',
                'deals' => 'deals',
                'idle' => 'with no activity in 7 days',
                'all_touched' => 'all touched in the last 7 days',
                'ranked_note' => 'Ranked by deal count, highest first. Currencies are never converted or combined.',
            ],
            'agenda' => [
                'title' => 'Agenda',
                'empty_title' => 'Nothing booked',
                'empty_body' => 'Meetings you book with a lead or deal will show up here.',
                ...
                'duration_hr' => '{{count}} hr',
            ],
            'activity' => [
                'empty_title' => 'No activity yet',
                'empty_body' => 'Calls, notes, uploads and stage changes on your records will appear here.',
                'system' => 'System',
                'fallback' => 'Activity',
            ],
            'snooze' => [
        ...
        'list_tour' => [
            ...
            'steps' => [
                'header' => [
                    ...
                    'body' => 'Total leads, overdue next actions, due this week, and hot leads sit under the title so you can see what needs attention.',
                ],
                'due_this_week' => [
                    'title' => 'Jump to what is due this week',
                    'body' => 'This chip applies a next-action filter for the week. Use it when you want that slice without opening Filters.',
                ],
                'search' => [
                    'title' => 'Search from the top bar',
                    'body' => 'Find a lead by name or contact details without leaving the list.',
                ],
                'import' => [
                    'title' => 'Import leads',
                    'body' => 'Bring leads in from a file. Use Add lead when you are creating one record.',
                ],
                'filters' => [
                    'title' => 'Narrow the list',
                    'body' => 'Filters open a workbench for lifecycle, owner, dates, and more. Saved views live here when filter v2 is on. A badge shows how many filters are active.',
                ],
                'add' => [
                    'title' => 'Create a lead',
                    'body' => 'Add lead opens the create form. Open an existing row to work the full lead page.',
                ],
                'filter_sentence' => [
                    'title' => 'See what you are looking at',
                    'body' => 'This line reads the active filters in plain language. Click it to open Filters again.',
                ],
                'table' => [
                    'title' => 'Work the list',
                    'body' => 'Click a row to open the lead. Checkboxes select rows for bulk update — the bulk bar appears after you select. Next action and status sit on the row.',
                ],
                'closing' => [
                    'title' => "You're ready",
                    'body' => 'Replay this guide anytime from Replay guide in the header.',
                ],
            ],
        ],
    ],
    ...
    'deals' => [
        ...
        'info' => [
            ...
            'value_insight' => [
                ...
                'commission_paid' => 'Commission paid',
                'commission_projected' => 'Commission (projected)',
                'commission_projected_hint' => 'Deal not won yet — estimated from current commission settings.',
                'section_value' => 'Property value',
                'section_conversion' => 'Currency conversion',
                'section_commission' => 'Commission split',
                'role_you' => 'You',
                'role_agent' => 'Agent',
                'role_upline' => 'Upline',
                'your_commission' => 'Your commission',
                'your_commission_projected' => 'Your commission (projected)',
                'revenue_to_company' => 'Revenue to company',
                'deduction' => 'Deduction',
                'exchange_rate' => 'Exchange rate',
                'in_company_currency' => 'In company currency',
                'editor' => [
                    'open' => 'Edit value',
                    ...
                    'deduction' => 'Deduction',
                    'deduction_note' => 'What is this deduction for?',
                    'currency' => 'Currency & exchange rate',
                    'currency_default' => 'Company default',
                    'exchange_rate' => 'Exchange rate to company currency',
                    'refresh_rate' => 'Refresh',
                    'rate_source' => 'Prefilled from the European Central Bank daily reference rate. Editable.',
                    'rate_unavailable' => 'Live rate unavailable — enter it manually.',
                    'save' => 'Save',
                    'cancel' => 'Cancel',
                ],
                'source' => 'Source',
        ...
        'list_tour' => [
            ...
            'steps' => [
                'header' => [
                    'title' => 'Your deals at a glance',
                    'body' => 'Active deals in the selected pipeline and won-this-week sit under the title.',
                ],
                'view_toggle' => [
                    'title' => 'Switch between Table and Board',
                    'body' => 'Table is for scanning, sorting, and bulk actions. Board is the pipeline by stage — drag a card to move the deal.',
                ],
                'pipeline' => [
                    'title' => 'Pin a pipeline, or see all',
                    'body' => 'The chip filters this list to one pipeline or All. Stats and the board follow the same pin.',
                ],
                'filters' => [
                    'title' => 'Narrow with Filters',
                    'body' => 'Stage, agent, dates, and more. A badge shows how many filters are on.',
                ],
                'search' => [
                    'title' => 'Search from the top bar',
                    'body' => 'Find a deal by name without leaving the list.',
                ],
                'actions' => [
                    'title' => 'Import or create',
                    'body' => 'Import brings deals in from a file. Add deal starts a new record in the current (or default) pipeline.',
                ],
                'filter_sentence' => [
                    'title' => 'See what you are looking at',
                    'body' => 'This line reads the active filters in plain language. Click it to open Filters again.',
                ...
                'table' => [
                    ...
                    'body' => 'Click a row to open the deal. Checkboxes select rows for bulk update — the bulk bar is table-only and appears after you select. Switch back to Board anytime from the toggle.',
                ],
                'closing' => [
                    'title' => "You're ready",
                    'body' => 'Replay this guide anytime from Replay guide in the header.',
        ...
        'workspace' => [
            ...
            'meetings' => [
                ...
                'no_phone_on_file' => 'No phone number on file for this lead.',
            ...
            'exposes' => [
                'title' => 'Exposes',
                'subtitle_deal' => 'Exposes submitted on this deal',
                'subtitle_lead' => "Every expose across this lead's deals",
                'add' => 'Add expose',
                'add_linked' => 'Link from project expose',
                'add_linked_hint' => 'Pull the expose from a project expose',
                'add_manual' => 'Upload expose manually',
                'add_manual_hint' => 'Attach an expose document yourself',
                'source_linked' => 'Linked to expose',
                'source_manual' => 'Manual upload',
                'empty' => 'No exposes yet',
                'empty_hint' => 'Link a project expose or upload a document to start tracking what the buyer has seen.',
                'load_failed' => 'Exposes could not be loaded',
                'retry' => 'Try again',
                'delete_confirm_message' => 'Remove this expose from the deal?',
                'no_exposes' => 'No project exposes available for this lead',
                'field_expose' => 'Project expose',
                'field_expose_placeholder' => 'Select an expose',
                'field_title' => 'Title',
                'field_amount' => 'Amount',
                ...
                'validation' => [
                    ...
                    'file_required' => 'Select a document to upload',
                    'amount_invalid' => 'Enter a valid amount',
                ],
                'messages' => [
                    'added' => 'Expose added',
                    'add_failed' => 'Failed to add expose',
    ...
    'tasks' => [
        ...
        'tour' => [
            ...
            'steps' => [
                'header' => [
                    'title' => 'Your tasks at a glance',
                    'body' => 'Open, overdue, and due-today counts sit under the title so you can see the load before you filter.',
                ],
                'view_toggle' => [
                    'title' => 'Switch between List and Board',
                    'body' => 'List groups tasks for scanning and bulk actions. Board is the same work by status column — drag to move. Your last view is kept in the URL.',
                ],
                'add' => [
                    'title' => 'Create a task',
                    'body' => 'Add task opens the form with checklist, attachments, and links to a deal, lead, or project.',
                ],
                'settings' => [
                    'title' => 'Task settings',
                    'body' => 'Open categories and related task settings from the gear. Most people will not see this control.',
                ],
                'quick_filters' => [
                    'title' => 'Jump to a slice of the work',
                    'body' => 'All, Assigned to me, Assigned by me, Open, Due today, Overdue, and Mentioned — counts are live. These combine with the full Filters drawer.',
                ],
                'group_by' => [
                    'title' => 'Group the list',
                    'body' => 'Due date, Category, or None. Group by only appears in List — this step switches you there first.',
                ],
                'filters' => [
                    'title' => 'Narrow with Filters',
                    'body' => 'Open the drawer for assignee, category, dates, and saved views. A badge shows how many filters are on.',
                ],
                'filter_sentence' => [
                    'title' => 'See what you are looking at',
                    'body' => 'This line reads the active filters in plain language. Click it to open Filters again.',
                ...
                'search' => [
                    'title' => 'Search from the top bar',
                    'body' => 'The search box in the page header finds tasks by name without leaving this list.',
                ],
                'body' => [
                    'title' => 'Open a task, or select several',
                    'body' => 'Click a row or card to open it. In List, checkboxes select rows for bulk update or delete — the bulk bar appears after you select.',
                ],
                'closing' => [
                    'title' => "You're ready",
                    'body' => 'Replay this guide anytime from Replay guide in the header.',
    ...
    'settings' => [
        'preferences_tour' => [
            ...
            'steps' => [
                'timezone' => [
                    'title' => 'Times in the CRM use this zone',
                    'body' => 'Pick your timezone when per-user timezone is on. Every timestamp you see follows this zone.',
                ],
                'browser_sync' => [
                    'title' => 'Keep in sync with this browser',
                    'body' => 'When this is on, the CRM may update your zone to match the browser on the next visit. Turn it off to lock the picker value.',
                ],
                'in_app_alerts' => [
                    'title' => 'In-app alerts',
                    'body' => 'Position, duration, and mute for toast alerts in this browser session. These are already saved to your account.',
                ],
                'notifications' => [
                    'title' => 'Choose which notifications you get',
                    'body' => 'Turn a type off to stop email, in-app, and push for that type. Security and account emails cannot be turned off.',
                ],
                'closing' => [
                    'title' => "You're ready",
                    'body' => 'Replay this guide anytime from Replay guide at the top of this page. Meeting reminder times are a separate page under Reminder preferences.',
                ],
            ],
        ],
        'reminder_preferences_tour' => [
            ...
            'steps' => [
                'enable' => [
                    ...
                    'body' => 'These times notify you before meetings. A single meeting can still override them. Use Enable reminders to turn the whole set off.',
                ],
                'rows' => [
                    'title' => 'Set when you are notified',
                    'body' => 'Each row is “this long before the meeting.” Add more (up to 20) or remove extras — at least one row stays.',
                ],
                'save_reset' => [
                    'title' => 'Save, or restore defaults',
                    'body' => 'Save writes your times. Reset to defaults restores 1 hour, 30 minutes, 15 minutes, and 5 minutes after a confirm.',
                ],
                'defaults' => [
                    'title' => 'What you get if you never customize',
                    'body' => 'If you have not set custom reminders, you are notified 1 hour, 30 minutes, 15 minutes, and 5 minutes before the meeting.',
                ],
                'closing' => [
                    'title' => "You're ready",
                    'body' => 'Replay this guide anytime from Replay guide at the top of this page. Timezone and in-app alerts live under Preferences.',
                ],
            ],
        ],
    ],
