<div {{ $attributes->merge(['class' => 'form-group my-3']) }} >
    ...
    <div class="input-group">
        <select class="form-control select-picker" id="currency_{{ $fieldId }}" name="currency_{{ $fieldId }}" data-live-search="true" style="max-width: 70px; min-width: 60px; width: 70px;">
            @php
