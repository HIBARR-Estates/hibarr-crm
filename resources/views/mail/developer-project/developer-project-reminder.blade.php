{{--
  Hibarr branded Project reminder — SMTP / UNS body fallback.
  Keep in sync with resources/views/mail/project/developer-project-reminder.plunk.html
--}}
...
<span style="display:inline-block;width:18px;height:2px;background-color:#003160;vertical-align:middle;margin-right:10px"></span>Project Reminder
</td>
</tr>
</table>
</td>
...
<div style="font-family:'DM Mono',Consolas,monospace;font-size:14px;color:#4a5272;line-height:1.6;margin-bottom:4px">{{ $projectTitle }}</div>
</div>
...
<p>Review this project and take the appropriate next steps.</p>
</td>
</tr>
<tr>
