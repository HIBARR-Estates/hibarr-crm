{{--
  Hibarr branded Flight reminder — SMTP / UNS body fallback.
  Keep in sync with resources/views/mail/lead-flight-itinerary/lead-flight-itinerary-reminder.plunk.html
--}}
...
<span style="display:inline-block;width:18px;height:2px;background-color:#003160;vertical-align:middle;margin-right:10px"></span>Flight Reminder
</td>
</tr>
</table>
</td>
...
<div style="font-family:'DM Mono',Consolas,monospace;font-size:14px;color:#4a5272;line-height:1.6;margin-bottom:4px">{{ $flightTitle }}</div>
</div>
