{{--
  Hibarr branded note reminder — SMTP / UNS body fallback.
  Keep in sync with resources/views/mail/note/note-reminder.plunk.html
--}}
...
<span style="display:inline-block;width:18px;height:2px;background-color:#003160;vertical-align:middle;margin-right:10px"></span>Note Reminder
</td>
</tr>
</table>
</td>
...
@if($noteTitle !== '')
<div style="font-family:'DM Mono',Consolas,monospace;font-size:14px;color:#4a5272;line-height:1.6;margin-bottom:4px">{{ $noteTitle }}</div>
@endif
@if($noteExcerpt !== '')
<div style="font-family:Syne,Georgia,serif;font-size:14px;line-height:22px;color:#0a0e1a;margin-top:14px">{{ $noteExcerpt }}</div>
@endif
</div>
