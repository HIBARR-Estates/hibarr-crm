{{--
  Hibarr branded Unit reminder — SMTP / UNS body fallback.
  Keep in sync with resources/views/mail/developer-project-unit-type/developer-project-unit-type-reminder.plunk.html
--}}
...
<span style="display:inline-block;width:18px;height:2px;background-color:#003160;vertical-align:middle;margin-right:10px"></span>Unit Reminder
</td>
</tr>
</table>
</td>
...
<div style="font-family:'DM Mono',Consolas,monospace;font-size:14px;color:#4a5272;line-height:1.6;margin-bottom:4px">{{ $unitTitle }}</div>
</div>
...
<p>Review this unit and take the appropriate next steps.</p>
</td>
</tr>
<tr>
