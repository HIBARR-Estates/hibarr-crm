...
@push('scripts')
    <script>
        $(document).ready(function() {
            ...
            // Initialize select picker for edit modal when it opens
            $('#editCategoryModal').on('shown.bs.modal', function() {
                $('#edit_custom_field_group_id').selectpicker('refresh');
            });
            ...
            //                 $('#edit_custom_field_group_id').val(response.category
            //                     .custom_field_group_id);
            //                 $('#edit_custom_field_group_id').selectpicker('refresh');
            //                 $('#editCategoryForm').attr('action',
            //                     "{{ route('custom-field-categories.update', ':id') }}"
            //                     .replace(':id', response.category.id));
            //                 $('#editCategoryModal').modal('show');
            //             }
            //         }
            //     });
