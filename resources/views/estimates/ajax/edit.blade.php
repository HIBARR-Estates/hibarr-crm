...
@if ((!in_array('client', user_roles()) && !in_array('clients', user_modules())) || (in_array('client', user_roles()) && !in_array('estimates', user_modules())))
        ...
        <div class="row px-lg-4 px-md-4 px-3 pt-3">
            ...
            <div class="col-md-4">
                ...
                <div class="form-group c-inv-select mb-4">
                    @if(isset($isClient) && $isClient == true)
                        <div class="input-group">
                            <input type="hidden" name="client_id" id="client_id" value="{{ $estimate->client_id }}">
                            <input type="text" value="{{ $estimate->client->name_salutation }}"
                                class="form-control height-35 f-15 readonly-background" readonly>
                        </div>
                    @else
            ...
            <div class="col-md-12 my-3">
                <div class="form-group">
                    ...
                    <div id="description">{!! clean_html($estimate->description) !!}</div>
