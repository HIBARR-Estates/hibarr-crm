                        ...
                        <div class="card-horizontal">
                            ...
                            <div class="card-body border-0 pl-0 py-1">
                                ...
                                @php
                                    ...
                                    $client = \App\Models\User::where('id', $discussion->added_by)->where('is_client_contact', 1)->first();
                                @endphp
                                @if(($isClient == true) && $client)
                                    <div class="text-grey f-10 float-left mt-0">{{ __('(Added By : ') . $client->name . ')' }}</div><br/>
                                @endif
                                <div class="card-text f-14 text-dark-grey text-justify">{!! clean_html($discussion->message) !!}
                                </div>
                            </div>
                        </div>
                    </div>
