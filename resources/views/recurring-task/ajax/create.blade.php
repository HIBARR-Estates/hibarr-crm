...
{{--                            ></x-forms.select2-ajax>--}}
                                    ...
                                    @php
                                        if ($item->slug == 'done' || $item->slug == 'to_do') {
                                            ...
                                            elseif($item->slug == 'in_review'){
                                                $icon = "<i class='fa fa-circle mr-2 text-purple'></i>".$item->column_name;
                                            }
                                            elseif($item->slug == 'on_hold'){
                                                $icon = "<i class='fa fa-circle mr-2 text-warning'></i>".$item->column_name;
                                            }
                                            else {
                    ...
                    <div class="col-md-12">
                        <div class="form-group my-3">
                            ...
                            <div id="description">{!! clean_html($task ? $task->description : '') !!}</div>
                        ...
                        <div class="form-group my-3">
                            <div class="d-flex">
                                <x-forms.checkbox :fieldLabel="__('modules.events.repeat')" fieldName="repeat"
                                                  fieldId="repeat-task" :checked="true"/>
                            </div>
                        </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#save-more-task-form').click(function () {
            ...
            const url = "{{ route('recurring-task.store') }}?taskId={{$task ? $task->id : ''}}&add_more=true";
        ...
        $('#save-task-form').click(function () {
            ...
            const url = "{{ route('recurring-task.store') }}?taskId={{$task ? $task->id : ''}}";
