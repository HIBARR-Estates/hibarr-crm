...
<!-- NAV ITEM - PROPERTIES -->
@if (!in_array('purchase', user_modules()) && in_array('products', user_modules()) && $sidebarUserPermissions['view_product'] != 5 && $sidebarUserPermissions['view_product'] != 'none')
        <x-menu-item icon="house-door" :text="__('app.menu.properties')" :link="route('products.index')">
            <x-slot name="iconPath">
                <path d="M8.707 1.5a1 1 0 0 0-1.414 0L.646 8.146a.5.5 0 0 0 .708.708L2 8.207V13.5A1.5 1.5 0 0 0 3.5 15h9a1.5 1.5 0 0 0 1.5-1.5V8.207l.646.647a.5.5 0 0 0 .708-.708L13 5.793l-2.293-2.293z"/>
                <path d="M13 7.207V13.5a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5V7.207L8 2.207l5 5z"/>
            </x-slot>
        </x-menu-item>
@endif
...
<!-- NAV ITEM - DEVELOPERS -->
@if (!in_array('client', user_roles()) && in_array('developers', user_modules()) && isset($sidebarUserPermissions['view_developers']) && $sidebarUserPermissions['view_developers'] != 5 && $sidebarUserPermissions['view_developers'] != 'none')
    <x-menu-item icon="building" :text="__('app.menu.developers')">
        <x-slot name="iconPath">
            <path d="M2.5 3A1.5 1.5 0 0 0 1 4.5v.793c.026.009.051.02.076.032L7.674 8.51c.206.1.446.1.652 0l6.598-3.185A.755.755 0 0 1 15 5.293V4.5A1.5 1.5 0 0 0 13.5 3h-11Z"/>
            <path d="M15 6.954 8.978 9.86a2.25 2.25 0 0 1-1.956 0L1 6.954V11.5A1.5 1.5 0 0 0 2.5 13h11a1.5 1.5 0 0 0 1.5-1.5V6.954Z"/>
        </x-slot>
        <div class="accordionItemContent">
            @if ($sidebarUserPermissions['view_developers'] != 5 && $sidebarUserPermissions['view_developers'] != 'none')
                <x-sub-menu-item :link="route('developers.index')" :text="__('modules.developers.developers')" />
            @endif
            @if (isset($sidebarUserPermissions['view_developer_projects']) && $sidebarUserPermissions['view_developer_projects'] != 5 && $sidebarUserPermissions['view_developer_projects'] != 'none')
                <x-sub-menu-item :link="route('developer-projects.index')" :text="__('modules.developers.projects')" />
            @endif
        </div>
    </x-menu-item>
@endif
