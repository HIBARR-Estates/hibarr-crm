            ...
            <div class="add-client bg-white rounded">
                ...
                <div id="normal-fields-container">
                    <div class="row mx-2">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <x-forms.phone fieldId="mobile" :fieldLabel="__('modules.lead.mobile')" fieldName="mobile" :fieldPlaceholder="__('placeholders.mobile')"
                                :fieldValue="$leadContact->mobile" :country="$leadContact->country"></x-forms.phone>
                        </div>
                ...
                <div class="row p-20">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <x-forms.phone fieldId="mobile_secondary" :fieldLabel="__('modules.lead.mobile') . ' (' . __('app.secondary') . ')'" fieldName="mobile_secondary" :fieldPlaceholder="__('placeholders.mobile')"
                            :fieldValue="$leadContact->mobile_secondary ?? ''" :country="$leadContact->country"></x-forms.phone>
                    </div>
