...
used for HIB-1234 ("Add product tour to personal dashboard") as a concrete
...
- Record the returned issue key (e.g. `HIB-1234`) — everything downstream
  is named from it.
...
e.g. `HIB-1234-add-product-tour-to-personal-dashboard`. Lowercase, hyphens,
